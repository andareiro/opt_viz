...
## Options Value Explorer: Rationale
...
*Solution:* The Options Value Explorer! This tool presents an interactive visualization to allow students to explore how two different options respond differently to changes in the market environment, specifically: volatility, underlying price, and tenor.

[Value Explorer](https://andareiro.shinyapps.io/app_one) on [ShinyApps.io](http://www.shinyapps.io/)
...
Our Value Explorer tool goes one step further - and makes this visualization interactive!
...
## Further Development
We can extend the capabilities of the Value Explorer with further support:
